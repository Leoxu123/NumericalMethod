<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SOR iteration.aspx.cs" Inherits="web_SOR_iteration" %>
...
<body>
    ...
    <div>
        ...
        <h1 style="color: #000000; font-size: x-large;">SOR 迭代法</h1>
    
    </div>
    <table style="width:100%; height: 532px;" align="left" bgcolor="White" 
        frame="above">
    ...
    Width="650px" TextMode="MultiLine" Font-Size="Large"></asp:TextBox>
        ...
        <br />
                ...
                <br />
                <br />
                <asp:Label ID="Label9" runat="server" Text="松弛因子："></asp:Label>
                &nbsp;&nbsp;&nbsp;
                <asp:TextBox ID="txt_w" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                    ControlToValidate="txt_w" Display="Dynamic" ErrorMessage="不能为空!"></asp:RequiredFieldValidator>
                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" 
                    ControlToValidate="txt_w" ErrorMessage="必须为数字！" 

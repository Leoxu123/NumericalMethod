<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Lagrange interpolation.aspx.cs" Inherits="web_Lagrange_interpolation" %>
...
<body>
    ...
    <div>
        ...
        <asp:TextBox ID="tbInputPoint" runat="server" BorderStyle="Solid" 
            Height="131px" TextMode="MultiLine" Width="149px"></asp:TextBox>
        <br />
        <br />
        x=
        <asp:TextBox ID="tbX" runat="server" Width="79px"></asp:TextBox>

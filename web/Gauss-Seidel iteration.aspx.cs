...
public partial class web_Gauss_Seidel_iteration : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        //test
        //double[] gg = new double[] { 1, 3,0,4,0,1,0,1,2};
        //double kk = ComputeMatrix.determinant(gg, 3);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    x = y;
                    y = allfunction.computeGauss(a, b, x, num);
                    count++;

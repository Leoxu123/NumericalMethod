<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sequential Gaussian Elimination.aspx.cs" Inherits="web_Sequential_Gaussian_Elimination" %>
...
<body>
    ...
    <div>
        ...
        <h1 style="color: #000000; font-size: x-large;">顺序高斯消元法</h1>
        ...
        <asp:Button ID="Button2" runat="server" Height="33px" Text="重 置 " 
            ...
            <td>
                ...
                <asp:TextBox ID="TextBox3" runat="server" Height="157px" ReadOnly="True" 
                    TextMode="MultiLine" Width="350px" Font-Size="Large" 
                    ></asp:TextBox>
                <br />
                <br />
